...
Version  : 2.1.5
Release  : 12
URL      : https://cran.r-project.org/src/contrib/pracma_2.1.5.tar.gz
Source0  : https://cran.r-project.org/src/contrib/pracma_2.1.5.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1535345308
